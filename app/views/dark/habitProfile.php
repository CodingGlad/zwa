...
<div class="page-container">
  ...
  <main class="detail-container">
    <div class="detail">
      ...
      <form method="post" action="http://habitjournal-6101.rostiapp.cz/public/profile/save">
        ...
        <form method="post" action="http://habitjournal-6101.rostiapp.cz/public/control">
