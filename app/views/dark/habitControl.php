...
<div class="page-container">
    ...
    <aside>
        ...
        <div class="aside-item">
            <a href="http://habitjournal-6101.rostiapp.cz/public/calendar" class="css-button">
                <img src="http://habitjournal-6101.rostiapp.cz/public/img/calendar.png" alt="calendar-icon">
                <p>
                    Habit Calendar
                </p>
            </a>
        ...
        <div class="aside-item">
            <a href="http://habitjournal-6101.rostiapp.cz/public/habitlist" class="css-button">
                <img src="http://habitjournal-6101.rostiapp.cz/public/img/menu.png" alt="menu-icon">
                <p>
                    Habit List
                </p>
            </a>
        ...
        <div class="aside-item">
            <a href="http://habitjournal-6101.rostiapp.cz/public/detail" class="css-button">
                <img src="http://habitjournal-6101.rostiapp.cz/public/img/add.png" alt="add-icon">
                <p>
                    Add Habit
                </p>
            </a>
        ...
        <div class="aside-item">
            <a href="http://habitjournal-6101.rostiapp.cz/public/occurence" class="css-button">
                <img src="http://habitjournal-6101.rostiapp.cz/public/img/clock.png" alt="clock-icon">
                <p>
                    Add Occurence
                </p>
            </a>
        ...
        <div class="aside-item">
            <a href="http://habitjournal-6101.rostiapp.cz/public/profile" class="css-button">
                <img src="http://habitjournal-6101.rostiapp.cz/public/img/user.png" alt="user-icon">
                <p>
                    Profile
                </p>
            </a>
    ...
    <main class="detail-container">
        <div class="detail">
            ...
            <form method="post" action="http://habitjournal-6101.rostiapp.cz/public/control/add">
    ...
    <script src="http://habitjournal-6101.rostiapp.cz/public/js/controlOnSubmit.js"></script>
</div>
</body>
</html>